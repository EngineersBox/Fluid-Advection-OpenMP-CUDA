...
void fft_forward(double* restrict v, fftw_complex* restrict output_buffer, int n) {

}

void fft_backward(fftw_complex* restrict input_buffer, double* restrict output, int n) {

}

void convolution_fftw_2d(double* restrict real, double* restrict input, double* restrict result) {
	int n_formula;
